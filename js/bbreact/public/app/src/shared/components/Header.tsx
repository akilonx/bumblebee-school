			...
			<nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
				<div className="flex flex-wrap justify-between items-center">
					<div className="flex justify-start items-center">
						...
						<a
							href="https://jiran.blackforestsofware.com"
						...
						<form action="#" method="GET" className="hidden md:block md:pl-2">
							...
							<div className="relative md:w-64 md:w-96">
								...
								<input
									...
									name="email"
									id="topbar-search"
									className="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
									placeholder="Search"
								/>
							</div>
						</form>
					...
					<div className="flex items-center lg:order-2">
						...
						>
							<div className="block py-2 px-4 text-lg font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300">
								Notifications
							</div>
							<div>
								<a
								...
								>
									...
									<div className="pl-3 w-full">
										<div className="text-gray-500 font-normal text-lg mb-1.5 dark:text-gray-400">
											New message from
						...
						>
							...
							<div className="grid grid-cols-3 gap-4 p-4">
								...
								>
									...
									<div className="text-lg text-gray-900 dark:text-white">Sales</div>
								</a>
								<a
									href="#"
									className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
								>
									...
									<div className="text-lg text-gray-900 dark:text-white">Users</div>
								</a>
								<a
									href="#"
									className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
								>
									...
									<div className="text-lg text-gray-900 dark:text-white">Inbox</div>
								</a>
								<a
									href="#"
									className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
								>
									...
									<div className="text-lg text-gray-900 dark:text-white">Profile</div>
								</a>
								<a
									href="#"
									className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
								...
								>
									...
									<div className="text-lg text-gray-900 dark:text-white">Products</div>
								</a>
								<a
									href="#"
									className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
								>
									...
									<div className="text-lg text-gray-900 dark:text-white">Pricing</div>
								</a>
								<a
									href="#"
									className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
								>
									...
									<div className="text-lg text-gray-900 dark:text-white">Billing</div>
								</a>
								<a
									href="#"
									className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
								>
									...
									<div className="text-lg text-gray-900 dark:text-white">Logout</div>
								</a>
							</div>
						</div>
						<button
							type="button"
							className="flex mx-3 text-lg bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
							id="user-menu-button"
							aria-expanded="false"
						...
						>
							<div className="py-3 px-4">
								...
								<span className="block text-lg text-gray-900 truncate dark:text-white">
									name@flowbite.com
								</span>
							</div>
							<ul className="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
								<li>
									<a
										href="#"
										className="block py-2 px-4 text-lg hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white"
									>
										My profile
									</a>
								</li>
							...
							<ul className="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
								<li>
									<a
										href="#"
										className="flex items-center py-2 px-4 text-lg hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
									>
										<svg
								...
								<li>
									<a
										href="#"
										className="flex justify-between items-center py-2 px-4 text-lg hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
									>
							...
							<ul className="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
								<li>
									<a
										href="#"
										onClick={signOut}
										className="block py-2 px-4 text-lg hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
									>
										Sign out
									</a>
								</li>
