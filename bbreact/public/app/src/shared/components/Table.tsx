...
export interface DataTableProps extends Omit<TableProps, "keys"> {
  keys: Array<string>;
  data: any[];
}
...
export function DataTable(props: DataTableProps) {
  ...
  const tkeys = keys.map((key) =>
    key && props.t ? props.t("label." + key) : key
  );
...
export interface TableStatusWrapperProps {
  cols: number;
  loading?: boolean;
  error?: boolean;
  t: Translator;
...
export const TableStatusWrapper: React.FC<TableStatusWrapperProps> = (
  props
) => {
